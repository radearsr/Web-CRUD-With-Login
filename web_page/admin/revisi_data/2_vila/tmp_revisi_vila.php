...
?>
	...
	<div class="container" style="margin-top:20px">
		<center><font size="6">Data Hasil Tembak (Vila Dago)</font></center>
		<hr>
		<a href="index_data.php?page=tmbh_dt_Vila&dt=Vila"><button class="btn btn-dark right">Tambah Data</button></a>
