<?php include('../../konek_all_dt.php'); ?>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_GET['id'])){
			...
			//query ke database SELECT tabel hasil tembak berdasarkan id = $id
		...
		if(isset($_POST['submit'])){
			...
			if($sql){
				echo '<script>alert("Berhasil menyimpan data."); document.location="index_data.php?page=tmp_utama";</script>';
			}else{
				echo '<script>alert("Gagal Memproses Update Data."); document.location="index_data.php?page=edit_dt_user";</script>';
			}
		}
		?>

		<form action="index_data.php?page=rvs_bandung_user&id=<?php echo $id; ?>" method="post">
			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					<input type="text" name="fee" class="form-control" value="<?php echo $data['fee']; ?>" readonly required>
				</div>
			</div>
			...
			<div class="item form-group">
				<div class="col-md-6 col-sm-6 offset-md-3">
					...
					<a href="index_data.php?page=tmp_rvs_bandung" class="btn btn-warning">Kembali</a>
				</div>
			</div>
		</form>
	</div>
