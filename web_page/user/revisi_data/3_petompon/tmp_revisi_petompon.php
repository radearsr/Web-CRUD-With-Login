...
?>
	...
	<div class="container" style="margin-top:20px">
		<center><font size="6">Data Hasil Tembak (Petompon)</font></center>
		<hr>
		<a href="index_data.php?page=tmbh_dt_Petompon&dt=Petompon"><button class="btn btn-dark right">Tambah Data</button></a>
