 ...
 <head> 
	...
	<script type="text/javascript">
	    $(document).ready(function(a){
	      // Variable Untuk Menambah Form
	      var html = '<p><div><tr><td style="display:none"><input type="hidden" name="alamat[]" value="<?php echo $_GET['dt'] ?>"></td><td><input class="form-control" type="text" name="nama_barang[]" id="childnama_barang"></td><td><input class="btn btn-danger" type="button" id="remove_table" value="x"></td></tr></div></p>';
...
<div id="add_data_popup" class="modal fade">
 <div class="modal-dialog">
  ...
  <div class="modal-header">
   ...
   <div class="modal-body">
      <center>
        <form method="POST" action="add_data/insert-data.php">
          <div class="form-inline" id="container_popup">
            <table>
              ...
              <tr>        
              	<td style="display:none"><input type="hidden" name="alamat[]" value="<?php echo $_GET['dt'] ?>"></td>
                <td><input class="form-control" type="text" name="nama_barang[]" id="nama_barang" required=""></td>
